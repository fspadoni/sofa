...
******************************************************************************/
#ifndef SOFA_COMPONENT_CONSTRAINTSET_LCPCONSTRAINTSOLVER_ASYNC_H
#define SOFA_COMPONENT_CONSTRAINTSET_LCPCONSTRAINTSOLVER_ASYNC_H
...
class LCPConstraintSolverAsync : public ConstraintSolverImpl
{
public:
    SOFA_CLASS(LCPConstraintSolverAsync, ConstraintSolverImpl);
...
protected:
    ...
    */
    LCPConstraintSolverAsync();

    /**
    * @brief Default Destructor
    */
    virtual ~LCPConstraintSolverAsync();
public:
    void init() override;
    ...
    Data<bool> displayTime; ///< Display time for each important step of LCPConstraintSolverAsync.
...
#endif // SOFA_COMPONENT_CONSTRAINTSET_LCPCONSTRAINTSOLVER_ASYNC_H
