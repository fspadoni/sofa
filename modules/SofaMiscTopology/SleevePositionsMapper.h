...
*/
class SOFA_MISC_TOPOLOGY_API SleevePositionsMapper: public DataEngine
{
public:
...
protected:
	...
	Data<sofa::helper::vector<unsigned int> > m_tetraTube;
	Data<sofa::helper::vector<unsigned int> > m_tetraFat;
